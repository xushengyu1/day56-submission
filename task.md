...
> **文档版本：** V1.1
> **日期：** 2026-07-16  
> **状态：** T00～T18 已实现并验证；T19 技术交付已完成，真实成员资料待团队补充
...
|---|---|---:|---|---|---|
| T00 | 工程骨架与 health | 1.0h | 无 | 全栈/DevOps | 已完成 |
| T01 | 数据模型与迁移 | 1.5h | T00 | 后端/数据 | 已完成 |
| T02 | 安全纯函数与状态机 | 1.5h | T00 | 后端/安全 | 已完成 |
| T03 | 认证与 RBAC | 1.5h | T01 | 后端/安全 | 已完成 |
| T04 | 审计、日志、幂等 | 1.5h | T01、T03 | 后端/安全 | 已完成 |
| T05 | 图片与脱敏 | 1.5h | T01、T02、T04 | 后端/AI 集成 | 已完成 |
| T06 | AI 适配器与 mock | 1.5h | T00、T02、T04 | AI 集成/后端 | 已完成 |
| T07 | 招领发布 | 2.0h | T03～T06 | 后端 | 已完成 |
| T08 | 失物与候选 | 2.0h | T03、T04、T06、T07 | 后端/AI 集成 | 已完成 |
| T09 | 身份证认领 | 1.5h | T02、T04、T08 | 后端/安全 | 已完成 |
| T10 | OTHER 认领 | 1.5h | T04、T06、T08 | 后端/AI 集成 | 已完成 |
| T11 | 主动/异常复核与管理员决定 | 2.0h | T05、T09、T10 | 后端 | 已完成 |
| T12 | 交接与时间线 | 1.0h | T09～T11 | 后端 | 已完成 |
| T13 | 前端壳与认证 | 1.5h | T03 | 前端 | 已完成 |
| T14 | 拾得者前端 | 2.0h | T07、T13 | 前端 | 已完成 |
| T15 | 失主 Top 5、认领与主动复核前端 | 2.0h | T08～T12、T13 | 前端 | 已完成 |
| T16 | 管理员五类复核前端 | 1.5h | T11、T13 | 前端 | 已完成 |
| T17 | E2E seed、主流程与主动复核 | 2.5h | T12、T14～T16 | QA/全栈 | 已完成 |
| T18 | 边界、安全与回归 | 2.0h | T17 | QA/安全 | 已完成 |
| T19 | 证据与答辩交付 | 1.5h | T18 | SZY/文档与证据 | 技术资料已完成；成员资料待人工补充 |
...
- [x] PRD V0.9 与详细设计 V1.4 的增量 Review 已确认。
- [x] `dev.md` V1.1 已定义工程、安全、TDD 和证据规则。
- [x] `task.md` V1.1 已按依赖拆分到文件、接口、测试、命令和验收标准。
- [ ] 真实成员负责人已填写。
- [x] Task T00～T18 已按实际测试和证据记录完成。
- [ ] 外部模型 Key/配额已验证；当前按 `AI_MODE=mock` 明确降级，未声明真实模型效果。
- [x] Docker、Python、Node 和 PostgreSQL 实际环境已验证。

当前剩余人工动作：由团队成员核对真实分工、个人贡献与外部模型 Key/配额；技术实现、回归结果和残留限制见 `evidence/development-records/T17.md`～`T19.md`。
